...
class ResRelAddEdit ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText5 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Result relay"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		bSizer103.Add( self.lbl_entity_code, 2, wx.ALL, 5 )
		...
		bSizer104.Add( self.txt_relay_name, 2, wx.ALL, 5 )
		...
		bSizer8.Add( bSizer1041, 1, wx.EXPAND, 5 )
