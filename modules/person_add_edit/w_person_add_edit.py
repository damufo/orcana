...
class PersonAddEdit ( wx.Dialog ):

	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = _(u"Person Add Edit"), pos = wx.DefaultPosition, size = wx.Size( 717,475 ), style = wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER )
		...
		self.m_staticText5 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Person"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText2 = wx.StaticText( self.panel, wx.ID_ANY, _(u"License:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText2.Wrap( -1 )

		bSizer9.Add( self.m_staticText2, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.txt_license = wx.TextCtrl( self.panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer9.Add( self.txt_license, 2, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		self.m_staticText3 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Surname:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText3.Wrap( -1 )

		bSizer10.Add( self.m_staticText3, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.txt_surname = wx.TextCtrl( self.panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer10.Add( self.txt_surname, 2, wx.ALL, 5 )
		...
		self.m_staticText311 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Gender:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		bSizer1011.Add( self.cho_gender_id, 2, wx.ALL, 5 )
		...
		self.m_staticText3111 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Birthdate:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText3111.Wrap( -1 )

		bSizer10111.Add( self.m_staticText3111, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.txt_birth_date = wx.TextCtrl( self.panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer10111.Add( self.txt_birth_date, 2, wx.ALL, 5 )
		...
		self.m_staticText31111 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Entity code:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		bSizer101111.Add( self.lbl_entity_code, 2, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
