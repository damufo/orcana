...
class Entities ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 832,520 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.m_staticText3 = wx.StaticText( self, wx.ID_ANY, _(u"Entities"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.btn_export = wx.Button( self, wx.ID_ANY, _(u"E&xport"), wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer71.Add( self.btn_export, 0, wx.ALL, 5 )
