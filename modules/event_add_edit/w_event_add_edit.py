...
class EventAddEdit ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText5 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Event"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		cho_codeChoices = []
		self.cho_code = wx.Choice( self.panel, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, cho_codeChoices, 0 )
		self.cho_code.SetSelection( 0 )
		bSizer10.Add( self.cho_code, 2, wx.ALL, 5 )
		...
		self.m_staticText31 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Gender:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		bSizer101.Add( self.cho_gender_id, 2, wx.ALL, 5 )
		...
		self.m_staticText32 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Name:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		bSizer103.Add( self.txt_name, 2, wx.ALL, 5 )
