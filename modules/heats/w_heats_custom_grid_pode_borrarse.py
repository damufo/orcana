...
class Heats ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 1119,865 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		bSizer11.Add( self.btn_official, 0, wx.ALL|wx.ALIGN_RIGHT, 5 )
		...
		bSizer9.Add( self.grd_results, 5, wx.ALL|wx.EXPAND, 5 )


		bSizer102.Add( bSizer9, 1, wx.EXPAND, 5 )


		bSizer7.Add( bSizer102, 1, wx.EXPAND, 5 )
		...
		bSizer72.Add( bSizer6, 0, wx.RIGHT|wx.LEFT, 5 )
