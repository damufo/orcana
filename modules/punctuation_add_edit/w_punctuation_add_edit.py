...
###########################################################################
## Class PunctuationAddEdit
###########################################################################

class PunctuationAddEdit ( wx.Dialog ):

	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = _(u"Punctuation Add Edit"), pos = wx.DefaultPosition, size = wx.Size( 904,478 ), style = wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER )
		...
		self.m_staticText5 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Punctuation"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		bSizer9.Add( self.txt_name, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		self.m_staticText3 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Points individual:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText3.Wrap( -1 )

		bSizer10.Add( self.m_staticText3, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.txt_points_ind = wx.TextCtrl( self.panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer10.Add( self.txt_points_ind, 1, wx.ALL, 5 )
		...
		self.m_staticText31 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Points relay:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText31.Wrap( -1 )

		bSizer101.Add( self.m_staticText31, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.txt_points_rel = wx.TextCtrl( self.panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer101.Add( self.txt_points_rel, 1, wx.ALL, 5 )
		...
		self.m_staticText32 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Entity to point ind.:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText32.Wrap( -1 )

		bSizer103.Add( self.m_staticText32, 1, wx.ALL, 5 )

		self.txt_entity_to_point_ind = wx.TextCtrl( self.panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer103.Add( self.txt_entity_to_point_ind, 1, wx.ALL, 5 )
		...
		self.m_staticText321 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Entity to point rel.:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText321.Wrap( -1 )

		bSizer1031.Add( self.m_staticText321, 1, wx.ALL, 5 )

		self.txt_entity_to_point_rel = wx.TextCtrl( self.panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer1031.Add( self.txt_entity_to_point_rel, 1, wx.ALL, 5 )
