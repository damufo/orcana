...
###########################################################################
## Class PhaseCategoriesCategoriesAdd
###########################################################################

class PhaseCategoriesCategoriesAdd ( wx.Dialog ):

	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = _(u"Phase categories categories add"), pos = wx.DefaultPosition, size = wx.Size( 909,528 ), style = wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER )
		...
		self.m_staticText5 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Phase categories categories add"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.lbl_action = wx.StaticText( self.panel, wx.ID_ANY, _(u"Action:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.lbl_action.Wrap( -1 )

		bSizer14.Add( self.lbl_action, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		cho_actionChoices = []
		self.cho_action = wx.Choice( self.panel, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, cho_actionChoices, 0 )
		self.cho_action.SetSelection( 0 )
		bSizer14.Add( self.cho_action, 2, wx.ALL, 5 )


		bSizer8.Add( bSizer14, 0, wx.ALIGN_RIGHT, 5 )
