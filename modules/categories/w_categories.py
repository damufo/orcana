...
class Categories ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 832,520 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.m_staticText3 = wx.StaticText( self, wx.ID_ANY, _(u"Categories"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText4 = wx.StaticText( self, wx.ID_ANY, _(u"Champ:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		bSizer73.Add( self.lbl_champ_name, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		bSizer7.Add( bSizer10, 0, wx.EXPAND|wx.RIGHT, 5 )
