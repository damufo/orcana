...
class EventCategories ( wx.Dialog ):

	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = _(u"Event categories"), pos = wx.DefaultPosition, size = wx.Size( 948,716 ), style = wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER )
		...
		self.m_staticText5 = wx.StaticText( self.panel, wx.ID_ANY, _(u"Event categories"), wx.DefaultPosition, wx.DefaultSize, 0 )
