...
###########################################################################
## Class IndInscriptions
###########################################################################

class IndInscriptions ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 832,520 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.m_staticText3 = wx.StaticText( self, wx.ID_ANY, _(u"Individual inscriptions"), wx.DefaultPosition, wx.DefaultSize, 0 )
